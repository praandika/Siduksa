                    ...
                    <table class="table align-items-center mb-0" id="dataTable">
                        <thead>
                            <tr>
                                ...
                                <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Pengepul</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <span class="text-xs font-weight-bold"><a href="{{ url('pembelian-transaction/'.$o->invoice.'') }}" data-toggle="tooltip" data-placement="top" title="Detail">{{ $o->invoice }}</a></span>
                                </td>
                                <td>
