<table>
    <thead>
        <tr>
            ...
            <th style="color: white; background-color: #5e61cd; font-weight: bold;">Supplier</th>
            <th style="color: white; background-color: #5e61cd; font-weight: bold;">Tanggal</th>
            <th style="color: white; background-color: #5e61cd; font-weight: bold;">Total Penjualan</th>
        </tr>
    </thead>
    <tbody>
        @php($no = 1)
